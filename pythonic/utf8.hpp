...
// inline size_t advance_utf8(TB &begin, TE end) noexcept {
//  uint8_t code = *begin;
//  if (code <= 0xc1) {
//    return ranges::advance(begin, 1, end);
//  } else if (code <= 0xdf) {
//    return ranges::advance(begin, 2, end);
//  } else if (code <= 0xef) {
//    return ranges::advance(begin, 3, end);
//  } else {
//    return ranges::advance(begin, 4, end);
//  }
//}
...
//  my_type operator[](
//      rng_detail::slice_bounds<size_t, rng_detail::from_end_<long>> offs)
//      const
//      noexcept {
...
//    auto length = size_t(0);
//    for (auto cur_iter = input.begin(); cur_iter != end_iter;) {
//      advance_utf8(cur_iter, end_iter);
//      length++;
//    }
//    return length;
//  }
//  size_t operator()(char const *input) const noexcept {
//    return (*this)(string_view(input));
//  }
//};

// auto len = view::view<len_fn>();

// template <typename F> auto operator|(char const *str, F func) {
//  return func(string_view(str));
//}
